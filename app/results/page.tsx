...
export default function ResultsPage() {
  ...
  const handlePlayAgain = async () => {
    ...
    if (isDynamicIconTheme) {
      ...
      try {
        // Fetch theme data
        const themeResponse = await gameApi.getTheme(
          settings.iconTheme!,
          limit
        );
    ...
    <>
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4 dark:bg-slate-900 sm:p-6">
        <motion.div
          ...
          className="w-full max-w-lg rounded-3xl border border-gray-200 bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-800 sm:p-8"
        >
          <div className="mb-8 text-center">
            <motion.div
              ...
              className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-blue-600 dark:bg-blue-500"
            >
            ...
            {isBestScore &&
              ...
              !showRecordAnimation && (
                <motion.div
                  ...
                  className="mt-4"
                >
                  <div className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-yellow-500 px-6 py-3 text-lg font-bold text-white shadow-lg ring-2 ring-amber-300 dark:from-amber-600 dark:to-yellow-600 dark:ring-amber-500 sm:text-xl">
          ...
          {winner && (
            <motion.div
              ...
              className="mb-6 rounded-2xl border border-blue-200 bg-blue-50 p-6 text-center dark:border-blue-800 dark:bg-blue-900/20"
            >
              <div className="mb-2 text-sm font-semibold uppercase tracking-wide text-blue-600 dark:text-blue-400">
                {mounted ? t('winner') : 'Winner'}
              </div>
              <div className="mb-2 text-2xl font-bold text-blue-600 dark:text-blue-400 sm:text-3xl">
                {winner.name}
              </div>
              <div className="text-xl font-bold text-gray-900 dark:text-gray-100 sm:text-2xl">
            ...
            {settings.numberOfPlayers === 1 ? (
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  className="rounded-2xl border border-gray-200 bg-gray-50 p-5 text-center dark:border-slate-700 dark:bg-slate-900"
                >
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-gray-200 bg-gray-50 p-5 text-center dark:border-slate-700 dark:bg-slate-900"
                >
                  <Move className="mx-auto mb-2 h-6 w-6 text-blue-600 dark:text-blue-400" />
                  <div className="mb-2 text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-400">
              ...
              >
                ...
                {players.map((player, index) => (
                  <motion.div
                    ...
                    className={`flex items-center justify-between rounded-2xl border p-4 shadow-md ${
                      player.id === winner?.id
                        ? 'border-blue-700 bg-blue-600 text-white dark:border-blue-600 dark:bg-blue-500'
                        : 'border-gray-200 bg-gray-50 text-gray-900 dark:border-slate-700 dark:bg-slate-900 dark:text-gray-100'
                    }`}
                  >
                    <span className="font-semibold">{player.name}</span>
                    <span className="text-lg font-bold">
                      {player.score}{' '}
                      {player.score === 1 ? t('pair') : t('pairs')}
                    </span>
                  </motion.div>
                ))}
              </motion.div>
          ...
          <div className="space-y-3">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="focus-visible-ring flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-md hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="focus-visible-ring flex w-full items-center justify-center gap-2 rounded-xl bg-gray-700 px-6 py-3 font-semibold text-white shadow-md hover:bg-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500"
            >
